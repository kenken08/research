<div class="modal fade" id="modalApprove{{$proposal->user_id}}" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width:1050px;margin-left:-210px;">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <textarea id="article-ckeditor{{$proposal->user_id}}" class="form-control" required name="feedback" rows="10" placeholder="Enter your Comment Here"></textarea>
                    </div>
                    <div class="col-md-6">
...
<script>
    CKEDITOR.replace('article-ckeditor{{$proposal->user_id}}',
    {
        toolbar :
        [

{!!Form::open(['action'=>'BannerController@addBanner','method'=>'POST', 'enctype'=>'multipart/form-data'])!!}            
{{Form::token()}}
<div class="modal fade" id="modalBanner" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-left">
                <h4 class="modal-title" id="modalLabeldanger"><i class="fa fa-plus"></i>Add New Banner</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" style="position: static">
                            ...
                            <input type="text" id="banner_title" class="form-control" name="banner_title" value="{{ old('atitle') }}" required autofocus>
